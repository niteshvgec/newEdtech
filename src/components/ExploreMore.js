...
import { HomePageExplore } from "../impdata/homepage-explore";
...
// Learn to build anything you can imagine
//  </p>
//  <div className="mt-5 flex flex-row rounded-full bg-richblack-800 border-richblack-100 px-1 py-1">
//     {
...
//     <div className="absoulate flex flex-row gap-10 justify-between w-full">
// {
